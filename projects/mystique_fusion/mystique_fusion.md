...
Основные сложности проекта были связаны с производительностью, задержками backend-запросов, весом билда и стабильностью клиентской части. В рамках разработки занимался оптимизацией асинхронного взаимодействия с backend-сервисами, снижением размера билда и исправлением runtime-багов.
