...
- Неоднократно писал код который стал фундаментом проекта (основным могу выделить: локализация, ui проекта, система нотификаций от бэка к клиенту, архитектура клиентской части)
