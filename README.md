...
Привет! Я Юра - Unity-разработчик с 3+ годами коммерческого и проектного опыта. 

Здесь собраны коммерческие проекты, тестовые задания и учебные прототипы, отражающие мой опыт в Unity-разработке: UI, игровые механики, архитектура клиентской части, DI, асинхронность, реактивность и оптимизация мобильных проектов.

Коммерческие проекты представлены описательно из-за ограничений NDA, публичный код доступен в тестовых заданиях и учебных проектах.
...
**Цифкор:** [О проекте/Исходники](https://github.com/ZloyGreGan/Cifkor_TestTask)  
