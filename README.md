...
Здесь представлены проекты разработанные мной в процессе изучения Unity. За 2 года 7 месяцев разработки в Unity я успел пополнить свое портфолио как простыми проектами, так и более серьезными работами с применением различных фреймворков. Проекты расположены в порядке от новых к старым.
